...
MS_ID = 'DBMC'
RC_ADDRESS = 'http://192.168.12.12:8484/catalog.json/'
##########################
...
class DBConnector(object):
    ...
    def __init__(self, client_id, rc_address):
        ...
        self.db = self.dbclient.sensor_readings
    ...
    def _confBroker(self):
            ...
            while True:
                try:
                    ...
                    services_list = conf['result']
                    for service in services_list:
                        if service['name'] == 'broker':
                            print(service['address']) 
                            self.broker_address = service['address']
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            print(msg.payload)
            post = json.loads(msg.payload.decode('utf-8'))
            for x in post['e']:
                ddc = {'bn': post['bn'],
