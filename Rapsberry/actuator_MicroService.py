...
class serviceLed(object):
    ...
    def GET(self, *uri, **params):
        ...
        if uri[0] == 'cold':
            ...
            GPIO.setup(led_pin, GPIO.OUT)   # Declaring pin 27 as output pin
...
if __name__ == '__main__':
    ...
    #cherrypy.quickstart(serviceLed())
    ...
    #register
    payload = json.dumps({'ID':'RPA01','end_point':[None,IPAddr+":8080"],'resources':'Actuator_temp'})
